...
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { mode_chroma }]; #IO_L4N_T0_34 Sch=sw[2]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { upscale }]; #IO_L9P_T1_DQS_34 Sch=sw[3]


##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { btn_sccb }]; #IO_L24N_T3_34 Sch=btn[1]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { piezo_stop }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
...
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { buzz }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]        
# set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports {  }]; #IO_L13P_T2_MRCC_13 Sch=jb_p[3]        
# set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports {  }]; #IO_L13N_T2_MRCC_13 Sch=jb_n[3]        
# set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33     } [get_ports {  }]; #IO_L22P_T3_13 Sch=jb_p[4]             
# set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33     } [get_ports {  }]; #IO_L22N_T3_13 Sch=jb_n[4]             
                                                                                                                                 
                                                                                                                                 
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[0] }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[1] }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[2] }]; #IO_L1P_T0_34 Sch=jc_p[2]              
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[3] }]; #IO_L1N_T0_34 Sch=jc_n[2]              
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[4] }]; #IO_L8P_T1_34 Sch=jc_p[3]              
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[5] }]; #IO_L8N_T1_34 Sch=jc_n[3]              
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[6] }]; #IO_L2P_T0_34 Sch=jc_p[4]              
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data[7] }]; #IO_L2N_T0_34 Sch=jc_n[4]              
                                                                                                                                 
                                                                                                                                 
##Pmod Header JD                                                                                                                  
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { jd[0] }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { ov7670_pclk }]; #IO_L5N_T0_34 Sch=jd_n[1]				 
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { SCL }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]            
...
set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { red_port[1] }];
set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS33 } [get_ports { red_port[2] }];
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { red_port[3] }];
