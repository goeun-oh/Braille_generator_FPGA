...
`define    ST2_O_F_BW      (`ST2_AB_BW-1) // reLU Activation, after Activation it becomes ST2_O_F_BW-1 bit     35bit


// `define    O_F_ACC_BW   27 // for demo, ST2_O_F_BW + log (CO)

//pooling interface
`define    ST2_Pool_IBW    `ST1_AR_BW // Stage2 Pooling input bitwidth
...
`define ST3_ACC_BW          (`ST3_KER_BW + $clog2(`FC_IN_VEC)) // 내적 누산기 비트폭 (45 + log2(48) -> 45 + 5.xx = 51)
