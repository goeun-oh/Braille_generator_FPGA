...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x475db0)) ;
...
extern "C" {
	...
	extern void subprog_m_11dfaddc_556ead11_2349(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 1038512, 168, 161080) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_11dfaddc_556ead11_2349), IP) ;
