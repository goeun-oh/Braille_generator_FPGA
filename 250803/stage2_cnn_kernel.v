...
// reg       signed [`ST2_AK_BW-1 : 0]    acc_kernel 	;
// reg       signed [`ST2_AK_BW-1 : 0]    r_acc_kernel   ;
...
// generate
// 	always @ (*) begin
// 		acc_kernel[0 +: `ST2_AK_BW]= 0;
// 		for(acc_idx =0; acc_idx < `KY*`KX; acc_idx = acc_idx +1) begin
// 			acc_kernel[0 +: `ST2_AK_BW] = $signed(acc_kernel[0 +: `ST2_AK_BW]) + $signed(r_mul[acc_idx*`ST2_M_BW +: `ST2_M_BW]); 
// 		end
// 	end
// 	always @(posedge clk or negedge reset_n) begin
// 	    if(!reset_n) begin
// 	        r_acc_kernel[0 +: `ST2_AK_BW] <= 0;
// 	    end else if(ce[LATENCY-2])begin
// 	        r_acc_kernel[0 +: `ST2_AK_BW] <= $signed(acc_kernel[0 +: `ST2_AK_BW]);
// 	    end
// 	end
// endgenerate
