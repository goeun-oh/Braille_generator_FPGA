...
# .mem 데이터 불러오기
values = [int(line.strip(), 16) for line in open("./mem_outputs/a_1.mem") if line.strip().startswith("0x")]
...
model.fc1.bias.data = torch.tensor([2816, -1792, -3832], dtype=torch.float32)  # 또는 정수 bias
...
input_tensor = load_mem_file_to_tensor('../PythonProject2/mem_outputs/a_1.mem', 28, 28)
